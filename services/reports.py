...
# Store outputs inside static/exports so Flask can serve them
OUTPUT_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "static", "exports"))
        ...
        for key, value in d.items():
            if isinstance(value, dict):
                ...
                for item in value:
                    ...
                    price = price_map.get(clean_item, "") if include_prices and price_map else ""
...
if __name__ == "__main__":
    ...
    for json_file, title, with_prices in configs:
        json_path = os.path.join(os.path.dirname(__file__), "..", "static", "data", json_file)
